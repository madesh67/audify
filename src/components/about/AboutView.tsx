...
export default function AboutView() {
  ...
  return (
    <div className="relative w-full min-h-screen bg-[#FEFEFE] pt-24 sm:pt-28 md:pt-32 pb-24 overflow-hidden">
      {/* Container snapping to strict design system guide rails: max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 */}
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 space-y-16 sm:space-y-20 md:space-y-24 lg:space-y-32">
        ...
        <section className="space-y-8 sm:space-y-10 md:space-y-12">
          {/* Eyebrow Pill */}
          <div className="inline-flex items-center gap-2.5 px-3.5 sm:px-4 py-1.5 rounded-full bg-neutral-100 border border-neutral-200/80 text-[10px] font-mono tracking-[0.25em] uppercase text-neutral-600 select-none">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
            <span>AUDIFY ACOUSTIC LABORATORIES • EST. 2021</span>
          </div>

          {/* Massive Grand Headline */}
          <div className="space-y-4 max-w-5xl">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black tracking-[-0.04em] uppercase text-neutral-950 leading-[0.94] sm:leading-[0.92]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-6">
              <div className="rounded-[2.5rem] p-1.5 sm:p-2 bg-neutral-100/70 border border-neutral-200/80 shadow-xs">
                <div className="rounded-[calc(2.5rem-0.375rem)] sm:rounded-[calc(2.5rem-0.5rem)] bg-white p-5 sm:p-7 md:p-8 grid grid-cols-2 gap-5 sm:gap-6 md:gap-8 border border-neutral-100/60">
                  <div className="space-y-1.5">
                    <div className="text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight text-neutral-950 font-mono">
                      0.02%
                    </div>
                    <div className="text-[10px] sm:text-[11px] font-mono uppercase tracking-wider text-neutral-400">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <p className="text-xs text-neutral-500">
                      Extended frequency resolution far beyond the audible human threshold.
                    </p>
                  </div>
        ...
        {/* =========================================================================
            SECTION 2: EDITORIAL SPLIT (Physical Acoustics over Digital Masks)
           ========================================================================= */}
        <section className="rounded-[2.5rem] p-1.5 sm:p-2 bg-neutral-100/70 border border-neutral-200/80">
          <div className="rounded-[calc(2.5rem-0.375rem)] sm:rounded-[calc(2.5rem-0.5rem)] bg-white p-6 sm:p-8 md:p-10 lg:p-16 border border-neutral-100/60">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-16 items-center">
              ...
              <div className="lg:col-span-6 flex justify-center">
                <div className="relative w-full max-w-sm sm:max-w-md aspect-square rounded-3xl bg-neutral-50/80 border border-neutral-200/80 p-6 sm:p-8 flex flex-col justify-between items-center overflow-hidden group">
                  ...
                  <div className="w-full text-center text-xs font-mono text-neutral-500 border-t border-neutral-200/60 pt-3 z-10">
        ...
        <section className="space-y-8 sm:space-y-10">
          <div className="space-y-3">
            ...
            <p className="text-xs sm:text-sm md:text-base text-neutral-600 max-w-2xl font-normal">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6">
            ...
            <div className="rounded-[2rem] p-1.5 bg-neutral-100/70 border border-neutral-200/80 hover:border-neutral-300 transition-all duration-300 flex flex-col">
              <div className="rounded-[calc(2rem-0.375rem)] bg-white p-6 sm:p-7 md:p-6 lg:p-8 flex flex-col justify-between flex-1 border border-neutral-100/60 space-y-6">
                <div className="space-y-4">
                  ...
                  <h3 className="text-lg sm:text-xl font-bold uppercase tracking-tight text-neutral-950">
                    Transducer Purism
                  </h3>
                ...
                <div className="pt-4 border-t border-neutral-100 flex items-center justify-between gap-2 text-[10px] sm:text-[11px] font-mono text-neutral-500">
            ...
            {/* Card 3 */}
            <div className="sm:col-span-2 lg:col-span-1 rounded-[2rem] p-1.5 bg-neutral-100/70 border border-neutral-200/80 hover:border-neutral-300 transition-all duration-300 flex flex-col">
              <div className="rounded-[calc(2rem-0.375rem)] bg-white p-6 sm:p-7 md:p-6 lg:p-8 flex flex-col justify-between flex-1 border border-neutral-100/60 space-y-6">
                <div className="space-y-4">
                  <div className="w-12 h-12 rounded-2xl bg-neutral-100 border border-neutral-200 flex items-center justify-center text-neutral-900">
        ...
        <section className="space-y-6 sm:space-y-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-3 sm:gap-4">
            <div className="space-y-2">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black tracking-[-0.03em] uppercase text-neutral-950">
                THE 4-PHASE CREATION PROTOCOL
              </h2>
            </div>

            <div className="text-xs font-mono text-neutral-500">
              Interactive Protocol Viewer • Phase {activeTab + 1} of 4
            </div>
          </div>

          {/* Phase Selector Tabs (2 cols mobile & tablet, 4 cols desktop) */}
            ...
            {laboratoryPhases.map((phase, idx) => {
              ...
              return (
                <button
                  ...
                  className={`p-3.5 sm:p-4 rounded-2xl text-left border transition-all duration-300 cursor-pointer min-h-[68px] sm:min-h-[76px] flex flex-col justify-between ${
                    isSelected
          ...
          <div className="rounded-[2.5rem] p-1.5 sm:p-2 bg-neutral-100/70 border border-neutral-200/80 transition-all duration-500">
            <div className="rounded-[calc(2.5rem-0.375rem)] sm:rounded-[calc(2.5rem-0.5rem)] bg-white p-6 sm:p-8 md:p-10 lg:p-12 border border-neutral-100/60 space-y-5 sm:space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-neutral-100 pb-5 sm:pb-6">
                <div>
                  ...
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-black uppercase tracking-tight text-neutral-950">
                    {laboratoryPhases[activeTab].title}
                  </h3>
                  <div className="text-xs sm:text-sm font-mono text-neutral-500 mt-1">
                    {laboratoryPhases[activeTab].subtitle}
                  </div>
                </div>

                <div className="text-3xl sm:text-4xl font-black font-mono text-neutral-200 self-start sm:self-center">
              ...
              <div className="pt-2 sm:pt-4 flex flex-wrap gap-2 sm:gap-2.5">
                {laboratoryPhases[activeTab].specs.map((spec, i) => (
                  <div
                    key={i}
                    className="inline-flex items-center gap-2 px-3 sm:px-3.5 py-1.5 rounded-full bg-neutral-100 border border-neutral-200/80 text-xs font-mono text-neutral-700"
                  >
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-stretch">
          ...
          {/* Quote Card (8 cols) */}
          <div className="lg:col-span-8 rounded-[2.5rem] p-1.5 sm:p-2 bg-neutral-100/70 border border-neutral-200/80 flex flex-col">
            <div className="rounded-[calc(2.5rem-0.375rem)] sm:rounded-[calc(2.5rem-0.5rem)] bg-white p-6 sm:p-8 md:p-10 lg:p-12 flex flex-col justify-between flex-1 border border-neutral-100/60 space-y-6 sm:space-y-8">
              <div className="space-y-3 sm:space-y-4">
                <div className="text-[10px] font-mono uppercase tracking-[0.25em] text-neutral-400">
                  FOUNDER’S MEMORANDUM
                </div>
                <blockquote className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold tracking-tight text-neutral-950 leading-snug">
              ...
              <div className="flex items-center gap-3.5 sm:gap-4 pt-5 sm:pt-6 border-t border-neutral-100">
                <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-neutral-950 text-white flex items-center justify-center font-bold text-xs sm:text-sm font-mono shrink-0">
                  JV
                </div>
                <div>
          ...
          <div className="lg:col-span-4 rounded-[2.5rem] p-1.5 sm:p-2 bg-neutral-100/70 border border-neutral-200/80 flex flex-col">
            <div className="rounded-[calc(2.5rem-0.375rem)] sm:rounded-[calc(2.5rem-0.5rem)] bg-white p-5 sm:p-6 md:p-8 flex flex-col justify-between flex-1 border border-neutral-100/60 space-y-5 sm:space-y-6">
              <div>
                <div className="text-[10px] font-mono uppercase tracking-[0.25em] text-neutral-400 mb-1.5 sm:mb-2">
                  GLOBAL ENGINEERING HUBS
                </div>
                <h4 className="text-base sm:text-lg font-bold uppercase tracking-tight text-neutral-950">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-1 gap-2.5 sm:gap-3 lg:gap-4 text-xs font-mono">
                <div
                  ...
                  className="p-3.5 rounded-2xl bg-neutral-50 border border-neutral-200/70 hover:bg-neutral-100 transition-colors cursor-pointer space-y-1 flex flex-col justify-between min-h-[84px] sm:min-h-[92px]"
                >
        ...
        {/* =========================================================================
            SECTION 6: GRAND EXPLORE CTA (Button-in-Button Trailing Icon Architecture)
           ========================================================================= */}
        <section className="rounded-[2.5rem] p-1.5 sm:p-2 bg-neutral-950 text-white shadow-2xl">
          <div className="rounded-[calc(2.5rem-0.375rem)] sm:rounded-[calc(2.5rem-0.5rem)] bg-neutral-900/90 p-6 sm:p-10 md:p-12 lg:p-16 text-center max-w-4xl mx-auto space-y-6 sm:space-y-8">
            
            <div className="inline-flex items-center gap-2 px-3.5 sm:px-4 py-1.5 rounded-full bg-white/10 border border-white/15 text-[10px] font-mono tracking-[0.25em] uppercase text-neutral-300">
              <Sparkles className="w-3.5 h-3.5 text-emerald-400" />
              <span>THE 16 REFERENCE INSTRUMENTS</span>
            </div>

            <div className="space-y-3 sm:space-y-4">
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black tracking-[-0.04em] uppercase text-white leading-[0.95]">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 pt-2">
              ...
              <Link
                ...
                className="w-full sm:w-auto group inline-flex items-center justify-center gap-3.5 px-7 sm:px-8 py-3.5 sm:py-4 min-h-[46px] sm:min-h-[48px] rounded-full bg-white text-neutral-950 font-bold text-xs sm:text-sm uppercase tracking-wider hover:bg-neutral-200 active:scale-[0.98] transition-all duration-300 cursor-pointer shadow-lg hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
              ...
              <button
                type="button"
                onClick={() => soundEngine.playChime()}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-6 py-3.5 sm:py-4 min-h-[46px] sm:min-h-[48px] rounded-full bg-white/5 border border-white/15 text-white hover:bg-white/10 active:scale-[0.98] transition-all duration-200 text-xs sm:text-sm font-mono tracking-wider uppercase cursor-pointer"
            ...
            <div className="text-[10px] sm:text-[11px] font-mono text-neutral-500 pt-2 sm:pt-4">
