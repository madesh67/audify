...
export default function AboutView() {
  ...
  return (
    <div className="relative w-full min-h-screen bg-[#FEFEFE] pt-24 sm:pt-28 md:pt-32 pb-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 space-y-24 sm:space-y-32">
        ...
        <section className="space-y-12">
          {/* Eyebrow Pill */}
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-neutral-100 border border-neutral-200/80 text-[10px] font-mono tracking-[0.25em] uppercase text-neutral-600 select-none">
          ...
          <div className="space-y-4 max-w-5xl">
            <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-[-0.04em] uppercase text-neutral-950 leading-[0.92]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-6">
              <div className="rounded-[2.5rem] p-2 bg-neutral-100/70 border border-neutral-200/80 shadow-xs">
                <div className="rounded-[calc(2.5rem-0.5rem)] bg-white p-6 sm:p-8 grid grid-cols-2 gap-6 sm:gap-8 border border-neutral-100/60">
        ...
        {/* =========================================================================
           ...
           ========================================================================= */}
        <section className="rounded-[2.5rem] p-2 bg-neutral-100/70 border border-neutral-200/80">
          <div className="rounded-[calc(2.5rem-0.5rem)] bg-white p-8 sm:p-12 lg:p-16 border border-neutral-100/60">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:col-span-6 space-y-6">
                ...
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-[-0.03em] uppercase text-neutral-950 leading-[1.05]">
                  PHYSICAL ACOUSTICS
                  <br />
                  OVER DIGITAL MASKS.
                </h2>
              ...
              <div className="lg:col-span-6 flex justify-center">
                <div className="relative w-full max-w-md aspect-square rounded-3xl bg-neutral-50/80 border border-neutral-200/80 p-8 flex flex-col justify-between items-center overflow-hidden group">
        ...
        <section className="space-y-10">
          <div className="space-y-3">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-[-0.03em] uppercase text-neutral-950">
              OUR UNCOMPROMISING STANDARDS
            </h2>
            <p className="text-sm sm:text-base text-neutral-600 max-w-2xl font-normal">
        ...
        <section className="space-y-8">
          ...
          <div className="rounded-[2.5rem] p-2 bg-neutral-100/70 border border-neutral-200/80 transition-all duration-500">
            <div className="rounded-[calc(2.5rem-0.5rem)] bg-white p-8 sm:p-12 border border-neutral-100/60 space-y-6">
              ...
              <div className="pt-4 flex flex-wrap gap-2.5">
                {laboratoryPhases[activeTab].specs.map((spec, i) => (
                  <div
                    key={i}
                    className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-neutral-100 border border-neutral-200/80 text-xs font-mono text-neutral-700"
                  >
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          {/* Quote Card (8 cols) */}
          <div className="lg:col-span-8 rounded-[2.5rem] p-2 bg-neutral-100/70 border border-neutral-200/80 flex flex-col">
            <div className="rounded-[calc(2.5rem-0.5rem)] bg-white p-8 sm:p-12 flex flex-col justify-between flex-1 border border-neutral-100/60 space-y-8">
              <div className="space-y-4">
                <div className="text-[10px] font-mono uppercase tracking-[0.25em] text-neutral-400">
                  FOUNDER’S MEMORANDUM
                </div>
                <blockquote className="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight text-neutral-950 leading-snug">
              ...
              <div className="flex items-center gap-4 pt-6 border-t border-neutral-100">
                <div className="w-12 h-12 rounded-full bg-neutral-950 text-white flex items-center justify-center font-bold text-sm font-mono">
                  JV
                </div>
                <div>
          ...
          <div className="lg:col-span-4 rounded-[2.5rem] p-2 bg-neutral-100/70 border border-neutral-200/80 flex flex-col">
            <div className="rounded-[calc(2.5rem-0.5rem)] bg-white p-8 flex flex-col justify-between flex-1 border border-neutral-100/60 space-y-6">
              <div>
                <div className="text-[10px] font-mono uppercase tracking-[0.25em] text-neutral-400 mb-2">
                  GLOBAL ENGINEERING HUBS
                </div>
                <h4 className="text-lg font-bold uppercase tracking-tight text-neutral-950">
              ...
              <div className="space-y-4 text-xs font-mono">
                ...
                >
                  <div className="flex justify-between items-center text-neutral-950 font-bold">
                    <span>STOCKHOLM</span>
                    <span className="text-[10px] text-emerald-600 font-semibold">R&D CORE</span>
                  </div>
                  <div className="text-neutral-500">Acoustic Transducer & Anechoic R&D</div>
                </div>
                ...
                >
                  <div className="flex justify-between items-center text-neutral-950 font-bold">
                    <span>KYOTO</span>
                    <span className="text-[10px] text-neutral-400">FABRICATION</span>
                  </div>
                  <div className="text-neutral-500">Titanium PVD & Monoblock CNC Milling</div>
                </div>
                ...
                >
                  <div className="flex justify-between items-center text-neutral-950 font-bold">
                    ...
                    <span className="text-[10px] text-neutral-400">DESIGN</span>
                  </div>
                  <div className="text-neutral-500">Kinetic Suspension & Haptic Design</div>
                </div>
              </div>
        ...
        {/* =========================================================================
           ...
           ========================================================================= */}
        <section className="rounded-[2.5rem] p-2 bg-neutral-950 text-white shadow-2xl">
          <div className="rounded-[calc(2.5rem-0.5rem)] bg-neutral-900/90 p-8 sm:p-14 lg:p-16 text-center max-w-4xl mx-auto space-y-8">
            
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/15 text-[10px] font-mono tracking-[0.25em] uppercase text-neutral-300">
              <Sparkles className="w-3.5 h-3.5 text-emerald-400" />
              <span>THE 16 REFERENCE INSTRUMENTS</span>
            </div>

            <div className="space-y-4">
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-[-0.04em] uppercase text-white leading-[0.95]">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
              ...
              <Link
                ...
                className="group inline-flex items-center gap-3.5 px-8 py-4 rounded-full bg-white text-neutral-950 font-bold text-xs sm:text-sm uppercase tracking-wider hover:bg-neutral-200 active:scale-[0.98] transition-all duration-300 cursor-pointer shadow-lg hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
                aria-label="Explore All Products"
              >
                <span>Explore All Products</span>
                <span className="w-6 h-6 rounded-full bg-neutral-950/10 flex items-center justify-center transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5">
              ...
              <button
                type="button"
                onClick={() => soundEngine.playChime()}
                className="inline-flex items-center gap-2.5 px-6 py-4 rounded-full bg-white/5 border border-white/15 text-white hover:bg-white/10 active:scale-[0.98] transition-all duration-200 text-xs sm:text-sm font-mono tracking-wider uppercase cursor-pointer"
            ...
            <div className="text-[11px] font-mono text-neutral-500 pt-4">
