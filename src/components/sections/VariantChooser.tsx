  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 sm:gap-6 md:gap-6 lg:gap-14 items-center">
          ...
          <div className="md:col-span-7 flex flex-col justify-center space-y-3 sm:space-y-4 md:space-y-3.5 lg:space-y-6 max-w-xl mx-auto md:max-w-none w-full">
            ...
            <div className="space-y-1">
              <div className="text-sm sm:text-base md:text-sm lg:text-lg font-medium text-neutral-950 tracking-tight">
                {activeVariant.tagline}
              </div>
              <p className="text-xs sm:text-sm md:text-xs lg:text-sm text-neutral-500 leading-relaxed font-normal">
