...
export default function VariantChooser({
  ...
  return (
    <section
      ...
      className={`relative w-full pt-16 sm:pt-3 lg:pt-4 pb-2 sm:pb-3 lg:py-4 text-neutral-950 select-none ${className}`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 relative z-10">
        {/* Section Header: Minimal & Connected to Section 1 */}
        <div className="flex flex-col items-center text-center mb-2 sm:mb-5 md:mb-5 lg:mb-10">
          <h2 className="text-xl sm:text-3xl md:text-3xl lg:text-5xl font-light tracking-tight text-neutral-950 leading-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 sm:gap-6 md:gap-6 lg:gap-14 items-center">
          ...
          <div className="md:col-span-5 flex justify-center md:justify-center lg:justify-start items-center">
            <div
              ...
              className="relative aspect-square w-full max-w-[170px] sm:max-w-[220px] md:max-w-[300px] lg:max-w-[440px] xl:max-w-[480px] rounded-2xl sm:rounded-3xl border border-neutral-200/90 bg-neutral-50/40 shadow-[0_10px_30px_rgba(0,0,0,0.03)] overflow-hidden flex items-center justify-center transition-all duration-700"
            >
              ...
              {(Object.keys(variants) as VariantColor[]).map((key) => {
                ...
                return (
                  <div
                    key={key}
                    className={`absolute inset-2.5 sm:inset-5 transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] ${
                      shouldShow
          ...
          <div className="md:col-span-7 flex flex-col justify-center space-y-2 sm:space-y-4 md:space-y-3.5 lg:space-y-6 max-w-xl mx-auto md:max-w-none w-full">
            {/* 3 Clean Finish Switcher Tiles */}
            <div className="space-y-1 sm:space-y-2.5">
              <div className="text-[9px] sm:text-[11px] font-mono tracking-[0.20em] sm:tracking-[0.25em] uppercase text-neutral-400">
                SELECT COLORWAY
              </div>

              <div className="grid grid-cols-3 gap-1.5 sm:gap-2.5 md:gap-2.5 lg:gap-3">
                {(Object.keys(variants) as VariantColor[]).map((key) => {
                  ...
                  return (
                    <button
                      ...
                      className={`group relative flex flex-col p-1.5 sm:p-3 md:p-2.5 lg:p-3.5 rounded-xl sm:rounded-2xl border text-left focus:outline-none cursor-pointer transition-all ${
                        isSelected
                    ...
                    >
                      <span
                        className={`w-3.5 h-3.5 sm:w-5 sm:h-5 rounded-full border shadow-inner mb-1 sm:mb-2.5 flex items-center justify-center shrink-0 ${
                      ...
                      <div
                        className={`font-mono text-[8px] sm:text-[10px] mt-0.5 truncate ${
            ...
            <div className="space-y-0.5 sm:space-y-1">
              ...
              <p className="text-[11px] sm:text-sm md:text-xs lg:text-sm text-neutral-500 leading-snug font-normal line-clamp-2 sm:line-clamp-none">
                {activeVariant.description}
              </p>
            </div>

            {/* Core Material Specs from Section 1 */}
            <div className="grid grid-cols-2 gap-2 sm:gap-6 pt-1.5 sm:pt-3 md:pt-3 lg:pt-4 border-t border-neutral-200/60 font-mono">
              <div>
                <div className="text-[8px] sm:text-[10px] uppercase tracking-[0.20em] sm:tracking-[0.25em] text-neutral-400">
                  CHASSIS ALLOY
                </div>
                <div className="text-[11px] sm:text-sm font-semibold text-neutral-950 tracking-tight mt-0.5 truncate">
            ...
            <div className="pt-1.5 sm:pt-2 flex flex-row items-center justify-between gap-2.5 sm:gap-4">
              <div>
                <div className="text-lg sm:text-3xl font-light tracking-tight text-neutral-950">
                  $499 <span className="text-[10px] sm:text-xs font-mono text-neutral-400 uppercase">USD</span>
                </div>
              </div>
              ...
              <button
                ...
                className="group inline-flex items-center justify-center gap-1.5 sm:gap-2 px-3.5 sm:px-6 md:px-5 lg:px-7 py-2 sm:py-3 md:py-2.5 lg:py-3.5 rounded-full bg-neutral-950 text-white font-semibold text-[11px] sm:text-xs lg:text-sm uppercase tracking-wider hover:bg-neutral-800 active:scale-[0.98] transition-all duration-200 shadow-sm hover:shadow-md cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:ring-offset-2"
              >
