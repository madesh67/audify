...
export const PRODUCTS: Product[] = [
  ...
  // ==========================================
  // WIRED EARPHONES (4 High-Resolution In-Ear Instruments)
  // ==========================================
  {
    id: "audify-iris-iem",
    slug: "audify-iris-iem",
    name: "Audify Iris IEM",
    series: "Precision In-Ear Series",
    price: 329,
    category: "earphones",
    badge: "Hybrid Acoustic",
    badgeType: "emerald",
    rating: 4.96,
    reviewCount: 720,
    tagline: "Cast Titanium Hybrid Triple-Driver In-Ear Monitor",
    description:
      "Engineered with dual high-frequency balanced armatures and a custom 12mm liquid crystal polymer dynamic driver inside a cast titanium acoustic chamber. Delivers microscopic resolution, linear low-end extension, and effortless transient speed.",
    keyHighlights: [
      "Dual Balanced Armatures + 12mm LCP Dynamic Transducer",
      "Cryogenic Cast Titanium Acoustic Nozzle & Housing",
      "0.78mm 2-Pin Silver-Plated Monocrystalline Copper Cable",
      "-26dB Passive Acoustic Isolation Seal",
    ],
    specs: [
      { label: "Driver Setup", value: "Hybrid 3-Way (2x Balanced Armature + 1x 12mm LCP Dynamic)" },
      { label: "Frequency Range", value: "8 Hz – 40,000 Hz" },
      { label: "Impedance", value: "24 Ω @ 1 kHz" },
      { label: "Sensitivity", value: "108 dB SPL/mW" },
      { label: "Enclosure Alloy", value: "Cryogenic Bead-Blasted Cast Titanium" },
      { label: "Cable Interface", value: "Detachable 0.78mm 2-Pin (3.5mm Gold Plug)" },
      { label: "Net Weight", value: "14g (Per Pair)" },
    ],
    variants: [
      {
        ...
        colorKey: "titanium",
        hex: "#1E2024",
        image: "/images/products/iris-iem-titanium.webp",
        finishDescription: "Non-reflective bead-blasted cast titanium with medical-grade silicone tips.",
      },
    ],
    boxContents: [
      "Audify Iris IEM Earpieces (Matched Pair)",
      "Silver-Plated OFC Braided 1.2m Audio Cable",
      "Milled Aluminum Pocket Travel Capsule",
      "6 Pairs Medical-Grade Silicone & Memory Foam Tips (S/M/L)",
      "6.35mm Gold-Plated Studio Adapter",
    ],
    inStock: true,
  ...
  {
    id: "audify-billet-precision",
    slug: "audify-billet-precision",
    name: "Audify Billet Precision",
    series: "Machined Micro Series",
    price: 189,
    category: "earphones",
    badge: "CNC Billet",
    badgeType: "default",
    rating: 4.93,
    reviewCount: 1140,
    tagline: "Solid 6061 Billet Aluminum Micro-Dynamic Earphone",
    description:
      "Precision lathe-turned from solid billets of 6061 aerospace aluminum. Features micro-acoustic back-venting and high-excursion 8.2mm graphene-coated diaphragms for visceral bass impact and featherlight ergonomic insertion.",
    keyHighlights: [
      "Lathe-Turned 6061 Aerospace Billet Shell",
      "8.2mm Custom Graphene-Deposited Micro-Dynamic Driver",
      "Micro-Acoustic Circumferential Damping Port",
      "Tangle-Free TPE Shielded High-Conductivity Lead",
    ],
    specs: [
      { label: "Transducer Type", value: "8.2mm Graphene-Coated Micro-Dynamic Transducer" },
      { label: "Frequency Range", value: "12 Hz – 32,000 Hz" },
      { label: "Impedance", value: "16 Ω" },
      { label: "Sensitivity", value: "104 dB SPL/mW" },
      { label: "Chassis Material", value: "Monoblock 6061 Aerospace Billet Aluminum" },
      { label: "Cable Termination", value: "3.5mm Straight Gold-Plated Mini Jack" },
      { label: "Net Weight", value: "11g" },
    ],
    variants: [
      {
        name: "Space Grey Billet",
        colorKey: "billet-grey",
        hex: "#3E4249",
        image: "/images/products/billet-precision-grey.webp",
        finishDescription: "Anodized space grey billet aluminum with brushed circumferential knurling.",
      },
    ],
    boxContents: [
      "Audify Billet Precision Earphones",
      "Compact Leatherette Pouch",
      "4 Pairs Acoustic Silicone Ear Tips",
      "Shirt Cable Clip",
    ],
    inStock: true,
    leadTime: "In Stock",
  ...
  {
    id: "audify-field-iem",
    slug: "audify-field-iem",
    name: "Audify Field IEM",
    series: "Stage & Monitoring Series",
    price: 249,
    category: "earphones",
    badge: "Stage Monitor",
    badgeType: "emerald",
    rating: 4.95,
    reviewCount: 680,
    tagline: "Coiled Cable High-Isolation Studio Stage In-Ear Monitor",
    description:
      "Purpose-built for live stage musicians, tracking engineers, and field recordists. Features Kevlar-reinforced spring coiled cabling, heavy-duty 90-degree gold 3.5mm studio lock connectors, and dual-damped acoustic filters.",
    keyHighlights: [
      "Kevlar-Reinforced Coiled Stage Lead (1.5m Extends to 3.0m)",
      "Heavy-Duty 90-Degree Molded 3.5mm Studio Lock Jack",
      "10mm High-Flux Dual-Cavity Neodymium Driver",
      "-28dB High-Attenuation Sound Stage Isolation",
    ],
    specs: [
      { label: "Driver Size", value: "10mm Dual-Cavity Neodymium Dynamic Transducer" },
      { label: "Acoustic Attenuation", value: "-28 dB Passive Ambient Isolation" },
      { label: "Frequency Range", value: "10 Hz – 30,000 Hz" },
      { label: "Impedance", value: "32 Ω" },
      { label: "Cable", value: "Kevlar-Core Coiled Flexible Audio Cable" },
      { label: "Connector", value: "90-Degree Gold-Plated 3.5mm Studio Plug" },
      { label: "Weight", value: "22g (Including Coiled Cable)" },
    ],
    variants: [
      {
        ...
        hex: "#18191B",
        image: "/images/products/field-iem-black.webp",
        finishDescription: "Impact-resistant textured matte black composite with coiled studio lead.",
      },
    ],
    boxContents: [
      "Audify Field IEM with Integrated Coiled Cable",
      "Ballistic Nylon Zipper Case",
      "3 Pairs Memory Foam Isolation Tips",
      "3 Pairs Dual-Flange Silicone Tips",
      "Threaded 6.35mm Gold-Plated Adapter",
    ],
    inStock: true,
    leadTime: "In Stock • Priority Dispatch",
    isFeatured: false,
  },
  {
    id: "audify-pulse-in-ear",
    slug: "audify-pulse-in-ear",
    name: "Audify Pulse In-Ear",
    series: "Dual-Driver Series",
    price: 219,
    category: "earphones",
    badge: "Dual Coaxial",
    badgeType: "default",
    rating: 4.92,
    reviewCount: 890,
    tagline: "Liquid-Metal Dual Coaxial Dynamic Acoustic Earphone",
    description:
      "Housing dual opposing 9mm + 6mm coaxial dynamic drivers inside a mirror-polished liquid-metal sound chamber. Provides deep acoustic separation, physical tactile sub-bass punch, and an integrated broadcast-grade inline microphone.",
    keyHighlights: [
      "Dual Coaxial Acoustic Drivers (9mm Sub + 6mm Treble)",
      "Mirror-Polished Liquid Metal Resonance Enclosure",
      "Integrated Low-Noise MEMS Inline Microphone",
      "4-Pole 3.5mm Low-Profile Right-Angle Gold Connector",
    ],
    specs: [
      { label: "Driver System", value: "Coaxial Dual Dynamic (9mm Woofer + 6mm Tweeter)" },
      { label: "Frequency Range", value: "6 Hz – 38,000 Hz" },
      { label: "Impedance", value: "20 Ω" },
      { label: "Sensitivity", value: "106 dB SPL/mW" },
      { label: "Shell", value: "Precision Hand-Polished Liquid Metal Alloy" },
      { label: "Microphone", value: "MEMS Broadcast Omnidirectional Capsule" },
      { label: "Net Weight", value: "18g" },
    ],
    variants: [
      {
        name: "Mirror Chrome & Obsidian",
        colorKey: "chrome",
        hex: "#2A2C30",
        image: "/images/products/pulse-in-ear-chrome.webp",
        finishDescription: "Hand-polished specular chrome acoustic shell with deep obsidian rubberized strain reliefs.",
      },
    ],
    boxContents: [
      "Audify Pulse In-Ear Earphones",
      "Magnetic Closure Leather Carrying Pouch",
      "5 Pairs Ergonomic Liquid Silicone Tips (XS/S/M/L/XL)",
